...
const header_footer = async (req, res) => {
    try {
      ...
      const insertHeaderFooterImages = await new Promise((resolve, reject) => {
        const sqlImages = 'INSERT INTO select_header_footer ( header_img, footer_img) VALUES ( ?, ?)';
    ...
    const selected_header_footer = async (req, res) => {
        try {
          // Fetch header and footer images in descending order by id
          const result = await new Promise((resolve, reject) => {
            const sql = 'SELECT * FROM select_header_footer ';
    ...
    module.exports = {header_footer,selected_header_footer}