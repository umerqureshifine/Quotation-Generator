...
const UpdateNotes = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(`https://quotation.queuemanagementsystemdg.com/api/notes`, { notes });
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleUpdate} className='form-control mb-2 mt-2'>
        ...
        <Link to={`/final-quotation/${id}`} className="btn btn-primary mt-3 mx-2 ">
